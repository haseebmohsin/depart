    ...
    <div class="py-6 text-gray-500 dark:text-gray-400">
        ...
        <ul class="mt-2">
            <li class="relative px-6 py-3 hover:bg-blue-100">
                ...
                <a class="inline-flex justify-between items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800" href="#">
        ...
        <ul>
            <li class="relative px-6 py-3 hover:bg-blue-100">
                <a class="inline-flex justify-between items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800" href="#">
                    <div class="inline-flex">
